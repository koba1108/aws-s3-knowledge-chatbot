module aws-s3-knowledge-chatbot
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/bedrockagent v1.50.7 // indirect
	github.com/aws/aws-sdk-go-v2/service/bedrockagentruntime v1.50.1 // indirect
